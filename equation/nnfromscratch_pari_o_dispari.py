...
nr_examples= 100
modelfilename = '../data/nnfromscratch_eq_pd' + str(nr_examples) + '.pkl'
...
inputs = np.linspace(-50, -50 + nr_examples, num = nr_examples).reshape(nr_examples,1)
...
def build_model(nn_hdim, X = inputs, num_passes=10000000, print_loss=False,save =True , epsilon = 0.001):
...
inputs_test = inputs = np.linspace(-50, -50 + nr_examples, num = nr_examples).reshape(nr_examples,1)
