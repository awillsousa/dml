...
exp_y = np.array([1, 2, 1, 0]) #training data Y
cur_cost = 0
...
# print(np.floor(run_forward([0,1])+0.5))
# print(np.floor(run_forward([1,1])+0.5))
# print(np.floor(run_forward([1, 0])+0.5))
# print(np.floor(run_forward([0, 0])+0.5))
