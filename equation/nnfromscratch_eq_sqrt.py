...
fact = 10
nr_examples= 50
modelfilename = '../data/nnfromscratch_eq_sqrt_' + str(nr_examples) + '.pkl'
...
def build_model(nn_hdim, X = inputs, num_passes=50000, print_loss=False,save =True , epsilon = 0.00001):
